    ...
    <div className="App">
      <div className='fondo'>
        <div id='contenedorRegister'>
          ...
          <input className='inputRegistro' placeholder='Ingrese su contraseña' type='password' value={password} id='password' onChange={(ev) => setPasword(ev.target.value)}></input>
